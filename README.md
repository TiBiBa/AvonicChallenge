...
It contains the first 151 Pokémons that the user is able to select as their main fighter. The data is retrieved is based on [this](https://www.kaggle.com/datasets/abcsds/pokemon?resource=download) Kaggle dataset. After selecting one and starting a battle a random opponent is selected. 
The Pokémon with the highest speed starts. The damage calculation is loosely based on [this](https://gamerant.com/pokemon-damage-calculation-help-guide/) source and uses the following equation:
```
